...
Las 6 secciones (turno 1: 10-hero, 30-platon, 60-completar; turno 2: 20-vitrina, 40-eventos,
50-praga504) ya estan completas y aprobadas. Alto total en celular ~9,000 px (tope HOJA-DIRECCION)."""
import glob,os
