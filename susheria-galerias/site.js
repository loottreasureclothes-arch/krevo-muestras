/* Sushería Galerías · FUNDACIÓN (base: La México): WhatsApp, menú hamburguesa, WA flotante, blindaje, anclas, ?mesa=N
   API para secciones:
     window.LM.WA            número (524491204319)
...
(function () {
  ...
  function initWa() {
    ...
    for (var i = 0; i < links.length; i++) {
      ...
      a.href = waUrl(msg && msg.length > 3 ? msg : "Hola, quiero hacer un pedido en Sushería Galerías.");
  ...
  function initWaHide() {
    ...
    var seen = [];
    function scan() {
      Array.prototype.forEach.call(document.querySelectorAll("[data-hide-wa], #menu, .lm-foot"), function (z) {
