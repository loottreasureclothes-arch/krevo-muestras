...
Las 7 secciones ya están completas:
  10-hero, 30-pruebas (componente firma "El par que embona"), 70-completar -> turno 1 (FUNDACIÓN)
  20-catalogo, 40-colchon, 50-visita, 60-recomiendan -> turno 2 (catálogo, carrito, visítanos, reseñas)
Header/menú/pie/WhatsApp flotante viven en template.html."""
import glob, os
