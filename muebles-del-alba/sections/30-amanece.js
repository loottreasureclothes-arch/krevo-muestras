/* 30-amanece: el sol de su logo abre la nave completa. Scrub reversible, SIN pin
   ...
   PROHIBIDO el arco: la foto es RECTA de principio a fin (Emanuel, FEEDBACK-1 punto 2).
   Aqui NO se vuelve a animar border-radius. Lo unico que se abre es el ancho (78% -> 100%). */
(function () {
  "use strict";
  ...
  function start() {
    var frame = sec.querySelector("[data-amanece-frame]");
    ...
    tl.fromTo(frame, { width: "78%" }, { width: "100%", ease: "none", duration: 1 }, 0)
